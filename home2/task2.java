 ...
 */
 ...
 public class task2 {
    public static void main(String[] args) {
        String recipe1 = "Арахис 100гр, мороженое 200гр. Возьмите арахис и измелчите его. Посыпьте измельчённый арахис на мороженое.".replaceAll("Арахис", "Колбаса")
                                                                                                                                     .replaceAll("арахис", "колбаса");                                                   
        String recipe2 = "Клубника 100гр, сгущенка 3кг. Смешать, есть) Радоваться жизни.".replaceAll("Клубника", "Вишня")
                                                                                         .replaceAll("клубника", "вишня")
                                                                                         .replaceAll("сгущенка", "молоко");
